...
var TOUR_CONFIGS = {
  ...
  13: [
    ...
    { title: "Read the chart", body: "The chart at the top tracks debt held by the public as a percentage of GDP. The red dashed line is CBO's current-law baseline; the green line is your scenario. The shaded band marks the fifty-year average." },
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, margin: "0 0 12px" }}>
        ...
        <InfoTip modal>
          ...
          <p style={{ fontSize: 13.5, color: "#374151", lineHeight: 1.6, margin: "12px 0 0" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10, flexWrap: "wrap", gap: 8 }}>
                <div>
                  ...
                  <div style={{ fontSize: 12, color: MUTED, marginTop: 2 }}>
                    {b.num_returns_millions.toFixed(1)}M returns · ${(b.taxable_income_b / 1000).toFixed(2)}T taxable income · average effective rate {b.effective_rate_pct}%
                  </div>
                </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div style={{ minWidth: 110, textAlign: "right" }}>
                  {delta !== 0 ? (
                    ...
                    <span style={{ fontSize: 13, color: MUTED }}>{b.effective_rate_pct}% (average)</span>
                  )}
                </div>
              </div>
